...
config = AutoConfig(search_path=ROOT_DIR / '.envs' / '.local' / '.django')
...
LOCAL_APPS = [
    ...
    'server.apps.places.apps.PlacesConfig',
...
# Do not add CORS headers to whitenoise responses
MIDDLEWARE = [
...
STATICFILES_DIRS = [str(SERVER_DIR / 'static')]
...
ADMINS = [('Aleksei Panfilov', 'aleert@yandex.ru')]
